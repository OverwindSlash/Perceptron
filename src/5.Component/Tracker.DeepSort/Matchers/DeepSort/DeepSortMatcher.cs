...
using Tracker.DeepSort.Matchers.Base;
using Tracker.DeepSort.Matchers.Trackers;
using Tracker.DeepSort.ReID;
using Tracker.DeepSort.Utils;
using Tracker.DeepSort.Utils.Algorithms.Hungarian;
using Tracker.DeepSort.Utils.DataStructs;
using Tracker.DeepSort.Utils.Pool;
...
public class DeepSortMatcher : Matcher
{
    ...
    public override IReadOnlyList<ITrack> Run(Mat frame, IPrediction[] detectedObjects, params int[] detectionObjectTypes)
    {
