...
public class SortTracker : ComponentBase, ITracker, IObjectTracker
{
    ...
    public SortTracker(Dictionary<string, string> preferences = null)
        : base(preferences)
    {
    ...
    {
        IouThreshold = TrackerSettings.ParseIouThreshold(preferences);
        MaxMisses = TrackerSettings.ParseMaxMisses(preferences);
    }
    ...
    public void Track(Frame frame)
    {
        ...
        foreach (var detectedObject in frame.DetectedObjects)
        {
            ...
            foreach (Track track in tracks)
            {
                ...
                {
                    detectedObject.TrackingId = track.TrackId;
                }
            }
        }
    }
